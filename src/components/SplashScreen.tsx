    ...
    <div className="flex flex-col items-center justify-center min-h-[100dvh] bg-transparent relative overflow-hidden">
      ...
      {[...Array(12)].map((_, i) => (
        <motion.div
          ...
          className="absolute w-1 h-1 bg-red-100 rounded-full blur-[1px] z-0"
        />
      ))}
        ...
        {!hasStarted ? (
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-white/50 leading-relaxed">
                استمتع بتجربة توقع دقيقة بنسبة %100 مع نظام GREENBET الذكي
              </p>
            </div>

            <button
              onClick={handleStart}
              className="w-full py-4 bg-red-600 rounded-2xl font-black text-white red-glow flex items-center justify-center gap-3 hover:brightness-110 active:scale-[0.98] transition-all group"
            >
          ...
          >
            ...
            <div className="flex flex-col items-center gap-6">
              ...
              >
                <div className="absolute -inset-8 bg-red-500/20 blur-[60px] rounded-full" />
                <h1 className="text-5xl md:text-7xl font-black font-orbitron text-center">
                  <span className="text-transparent bg-clip-text bg-gradient-to-br from-red-600 via-red-500 to-red-400">GREENBET</span>
                </h1>
              </motion.div>
            </div>

            <div className="flex flex-col items-center gap-4 w-full relative z-10">
              <p className="text-[12px] font-bold text-red-400/60 uppercase font-sans drop-shadow-[0_0_5px_rgba(239,68,68,0.4)]">جاري تحضير تجربة سحرية</p>
